...
\begin{frame}
	...
	\begin{itemize}
		\item Generación de un mapa local \textbf{denso} para SLAM en \textbf{tiempo real}.
        ...
        \item Probado en KITTI (outdoors) y Tsukuba (indoors).
        \item Funciona en trajectorias de gran longitud.
