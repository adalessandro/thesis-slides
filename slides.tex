...
\begin{figure}[!htb]
	...
	\subfloat[Ground-Truth]{\includegraphics[width=0.2\columnwidth]{./images/tsukuba_frame807_gt_high6.png}%
		\label{tsukuba_gt}}
	\\
	\subfloat[LIBELAS depth map]{\includegraphics[width=0.2\columnwidth]{./images/tsukuba_frame807_libelas_depth_high6.png}%
		\label{tsukuba_frame807_libelas_depth}}
	\hfil
	\subfloat[LIBELAS depth map error]{\includegraphics[width=0.2\columnwidth]{./images/tsukuba_frame807_libelas_error_high6.png}%
		\label{tsukuba_frame807_libelas_error}}
	\\
	\subfloat[Dense S-PTAM depth map]{\includegraphics[width=0.2\columnwidth]{./images/tsukuba_frame807_dense_high6.png}%
		\label{tsukuba_frame807_dense}}
	\hfil
	\subfloat[Dense S-PTAM depth map error]{\includegraphics[width=0.2\columnwidth]{./images/tsukuba_frame807_error_high6.png}%
...
\begin{frame}
	...
	\begin{figure}[!htb]
		...
		\\
		\subfloat[LIBELAS depth Map]{\includegraphics[width=0.2\columnwidth]{./images/tsukuba_frame1314_libelas_depth_high6.png}%
			\label{tsukuba_frame1314_libelas_depth}}
		\hfil
		\subfloat[LIBELAS depth map error]{\includegraphics[width=0.2\columnwidth]{./images/tsukuba_frame1314_libelas_error_high6.png}%
			\label{tsukuba_frame1314_libelas_error}}
		\\
		\subfloat[Dense S-PTAM depth map]{\includegraphics[width=0.2\columnwidth]{./images/tsukuba_frame1314_dense_high6.png}%
			\label{tsukuba_frame1314_dense}}
		\hfil
		\subfloat[Dense S-PTAM depth map error]{\includegraphics[width=0.2\columnwidth]{./images/tsukuba_frame1314_error_high6.png}%
			\label{tsukuba_frame1314_error}}
		\\
		\subfloat[Color metric]{\includegraphics[width=0.2\columnwidth]{./images/high6_bar.pdf}%
